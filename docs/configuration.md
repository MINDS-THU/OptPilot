...
`config` selects the schema. The older internal `config: compiled_study` format is generated by OptPilot and written to run directories; users normally do not write it.
