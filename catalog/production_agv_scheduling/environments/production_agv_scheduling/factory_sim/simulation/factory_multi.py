...
from factory_sim.simulation.line import Line
...
class Factory:
    ...
    """
    def __init__(self, layout_config: Dict, mqtt_client: MQTTClient, database: SimulationDatabase, no_faults: bool = False):
        ...
        # Topics are an internal compatibility surface in offline evaluation.
        # Do not let ambient host environment variables affect a simulation.
        self.topic_manager = TopicManager("optpilot_offline")

        self.lines: Dict[str, Line] = {}
        self.raw_material: RawMaterial
        self.warehouse: Warehouse
        self.order_generator: OrderGenerator
        self.kpi_calculator = KPICalculator(self.env, self.mqtt_client, self.database, self.topic_manager)
    ...
    def _create_warehouse_order_generator(self):
        ...
        for warehouse_cfg in self.layout.get('warehouses', []):
            common_args = {"env": self.env, "mqtt_client": self.mqtt_client, "database": self.database, "topic_manager": self.topic_manager, **warehouse_cfg}
