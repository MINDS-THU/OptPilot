...
from factory_sim.config.schemas import DeviceStatus, DeviceDetailedStatus
from factory_sim.utils.topic_manager import TopicManager
from factory_sim.config.topics import DEVICE_ALERT_TOPIC
...
class Vehicle(Device):
    ...
    """
    def __init__(self, env: simpy.Environment, id: str, position: Tuple[int, int], speed_mps: float, mqtt_client=None, database=None):
        super().__init__(env, id, position, "vehicle", mqtt_client, database)
