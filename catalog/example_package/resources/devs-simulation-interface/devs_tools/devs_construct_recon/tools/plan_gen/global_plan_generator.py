...
1. **External output to stdout/file**: If the requirement says "output to screen", "print", "save to file", "record", or "output the final statistics", this maps to Local output. DO NOT create dedicated "Log Collector" modules for this, every module can output to stdout itself.
