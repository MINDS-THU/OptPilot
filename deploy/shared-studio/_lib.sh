...
: "${WORKSPACE_RUNTIME_IMAGE:=optpilot/workspace-dev:code-server-4.137.0-node-22.19.0-uv-0.12.15}"
: "${WORKSPACE_RUNTIME_BASE_IMAGE:=ghcr.io/coder/code-server:4.137.0@sha256:57ac684d44deb6fa94317b3e8f3e128dd7fb897fffd95b4efcd16f56ce607971}"
