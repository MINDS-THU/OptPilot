...
# One logger belongs to one generation request. Worker threads explicitly copy
# this context when the planner and generator fan out work.
_llm_logger: ContextVar[Optional[LLMCallLogger]] = ContextVar(
    "devs_v3_llm_logger", default=None
)
